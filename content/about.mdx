...
I build production-grade security tooling — multi-agent LLM pipelines, IOC enrichment, identity automation, risk management. Every feature starts as a design doc that names the problem before naming the solution.
